...
public class CustomGlobalExceptionHandler<T> {
    ...
    public Result<T> exceptionHandler(HttpServletRequest req, NullPointerException e) {
        ...
        return Result.error(ErrorInfoEnum.BODY_NOT_MATCH);
    }
    ...
    @ResponseBody
    public Result<T> exceptionHandler(HttpServletRequest req, Exception e) {
        logger.error("未知异常！原因是:", e);
        return Result.error(ErrorInfoEnum.INTERNAL_SERVER_ERROR);
    }
}
