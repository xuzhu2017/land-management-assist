...
import com.xz.landmangementassist.exception.CustomGlobalException;
...
public class BeanUtil {
    ...
    public static <T> T transformFrom(@Nullable Object source, @NonNull Class<T> targetClass) {
        ...
        try {
            ...
            throw new CustomGlobalException(ErrorInfoEnum.DTO_TRANSFORM_ERROR.getResultCode(),
    ...
    public static void updateProperties(@NonNull Object source, @NonNull Object target) {
        ...
        try {
            ...
            throw new CustomGlobalException(ErrorInfoEnum.DTO_UPDATE_ERROR.getResultCode(), "Failed to copy properties",
                    e);
        }
    }
    ...
    public static <T> T createEntityFromDTO(@Nullable Object source, @NonNull Class<T> targetClass) {
        if (source == null) {
            return null;
        }
