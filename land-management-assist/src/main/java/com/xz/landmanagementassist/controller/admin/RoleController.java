...
public class RoleController {
    ...
    public Result<Boolean> delete(@RequestParam int roleId) {
    ...
    public Result<Void> updateMenuList(@RequestParam int rid, @RequestBody Map<String, List<Integer>> menusIds) {
        adminRoleMenuService.updateList(rid, menusIds);
        return Result.success(ErrorInfoEnum.UPDATE_SUCCESS);
    }
}
