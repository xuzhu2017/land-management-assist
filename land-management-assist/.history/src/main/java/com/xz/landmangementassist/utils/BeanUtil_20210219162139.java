...
import com.xz.landmanagementassist.exception.CustomerGlobalException;
...
public class BeanUtil {
    ...
    public static <T> T transformFrom(@Nullable Object source, @NonNull Class<T> targetClass) {
        ...
        try {
            ...
            throw new CustomerGlobalException("Failed to new " + targetClass.getName() + " instance or copy properties",
                    e);
        }
    }
    ...
    public static void updateProperties(@NonNull Object source, @NonNull Object target) {
        ...
        try {
            ...
            throw new CustomerGlobalException("Failed to copy properties", e);
        }
    }
