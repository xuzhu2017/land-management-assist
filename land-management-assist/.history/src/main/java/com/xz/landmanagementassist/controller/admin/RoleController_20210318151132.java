...
public class RoleController {
    ...
    public Result<Boolean> update(@RequestBody AdminRoleEntity requestRole) {
        return Result.success(adminRoleService.updateById(requestRole), ErrorInfoEnum.UPDATE_SUCCESS);
    }

    @PostMapping("/api/admin/role")
    public Result save(@RequestBody AdminRoleEntity requestRole) {
