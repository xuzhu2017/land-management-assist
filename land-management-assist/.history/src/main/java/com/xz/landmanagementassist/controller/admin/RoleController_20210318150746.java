...
public class RoleController {
    ...
    public Result<Boolean> delete(@RequestBody AdminRoleEntity requestRole) {
        AdminRole adminRole = adminRoleService.updateRoleStatus(requestRole);
        String message = "用户" + adminRole.getNameZh() + "状态更新成功";
        return Result.success(adminRoleService.delete(requestUser), ErrorInfoEnum.DELETE_SUCCESS);
    }
